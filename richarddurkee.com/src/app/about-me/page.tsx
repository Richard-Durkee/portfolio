    ...
    return (
      <div> 
        ...
        <div className='flex flex-col md:flex-row items-center'>
          ...
          <p className=''> My name is Richard F. Durkee, or Rick, and I am curious, user-focused, and self-motivated. relying on self-taught methods to realize my passion projects, alone I set-up my small-scale server and began configuration for novel operations, excitedly and securely hosting burner websites and creating a streaming device. My wondering self-instruction taught me the foundation of transcoding in microserver networks. </p>
        </div>
      </div>);
  }